...
<head>
    ...
    <title>PhallaDavid/Portfolio</title>
</head>
<body>
    <header class="header">
        <div class="loader">
            <span style="font-size: 20px;" >Portfolio.</span>
            
        </div>
        <i class="fa-solid fa-bars-staggered"  id="menu-button" aria-label="Open menu"></i>
        <nav class="navbar">
    ...
    <section class="home" id="home">
        <div class="home-content">
            <h1>Phalla David</h1>
            <!-- <h3 >And I'm a <span class="multiple-text">Developer</span></h3> -->
            
            <div class="social-media">
                <a href="https://www.facebook.com/phalla.david.31?mibextid=LQQJ4d"><i class="fa-brands fa-facebook"></i></a>
                <a href="https://www.instagram.com/daviqq____?igsh=dTB5c2JjanZmbmVq&utm_source=qr"><i class="fa-brands fa-instagram"></i></a>
                <a href="https://t.me/Rickyy_Doop"><i class="fa-brands fa-telegram"></i></a>
                <a href="https://github.com/PhallaDavid"><i class="fa-brands fa-github"></i></a>
            </div>
            <h3 id="typing-paragraph" ></h3>
    ...
    <section class="about" id="about">
        <div class="about-img">
            <img src="../image/2024-06-01 12.32.jpeg" alt="">
        </div>
        <div class="about-content">
            <h2 class="heading">ABOUT <span>Me</span></h2>
            <div class="container">
                <h3>My name is David,  currently i'm graduate of the Royal University of Phnom Penh (RUPP). With a strong foundation in web development, I am eager to apply my skills and knowledge in a professional setting.
<br>In addition to my technical expertise, I am a collaborative team player who thrives in group settings. My friendly demeanor and adaptability make me a valuable asset to any team. I am committed to contributing effectively and growing within a dynamic work environment.</h3>
...
@endif
    ...
    <form class="form" action="{{ route('contact.create') }}" method="POST">
            @csrf
            ...
            <div class="form-group">
                <label for="your_message">How Can I Help You?</label>
                <textarea name="your_message" id="your_message" rows="10" cols="50" required></textarea>
                @error('your_message')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
...
@endif
    ...
    <footer class="footer">
        <div class="footer-text">
            <p>Copyright &copy; 2024 by@PhallaDavid</p>
        </div>
            <div class="footer-iconTop">
                <a href="#home"><i class="fa-solid fa-arrow-up-wide-short"></i></a>
            </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const navLinks = document.querySelectorAll('.sidebar .nav-link'); // Ensure this class matches the actual class of your links
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const typingElement = document.getElementById('typing-paragraph');
    ...
    function typeWriter(element, text, speed, callback) {
        ...
        const interval = setInterval(() => {
            if (index < text.length) {
                ...
                if (callback) callback(); // Execute callback when typing is complete
            }
        }, speed);
    }

    function startTyping() {
        typeWriter(typingElement, paragraphs[currentParagraphIndex], 50, () => {
            // Wait for 2 seconds before starting to change the paragraph
            setTimeout(() => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    typeWriter(paragraph, text, speed);
});
